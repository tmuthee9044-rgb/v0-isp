        ...
        try {
          ...
          await sql`
            INSERT INTO customers (
              ...
              physical_country, physical_gps_coordinates, billing_address, billing_city, billing_postal_code,
              ...
              ${row.billing_address || null}, ${row.billing_city || null}, ${row.billing_postal_code || null},
