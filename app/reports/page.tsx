      ...
      try {
        ...
        setReportData({
          customers: {
            ...
            satisfaction: customersData.satisfaction || 0,
          ...
          billing: {
            ...
            collections:
              billingData.totalRevenue > 0
                ? ((billingData.totalRevenue - billingData.outstanding) / billingData.totalRevenue) * 100
                : 0,
            avgPaymentTime: billingData.avgPaymentTime || 0,
            paymentMethods: billingData.paymentMethods || [],
          },
          network: {
            uptime: networkData.uptime || 0,
            bandwidth: networkData.bandwidth || 0,
            latency: networkData.latency || 0,
            packetLoss: networkData.packetLoss || 0,
            activeConnections: networkData.activeConnections || customersData.totalCustomers || 0,
            routers: networkData.routers || { total: 0, online: 0, offline: 0 },
            incidents: networkData.incidents || 0,
            maintenanceHours: networkData.maintenanceHours || 0,
          },
          support: {
            totalTickets: supportData.totalTickets || 0,
            open: supportData.open || 0,
            inProgress: supportData.inProgress || 0,
            resolved: supportData.resolved || 0,
            avgResponseTime: supportData.avgResponseTime || 0,
          ...
          services: {
            totalPlans: servicesData.length || 0,
            activePlans: servicesData.filter((p: any) => p.status === "active").length || 0,
            subscribers: {},
            revenue: {},
          },
          hr: {
            ...
            turnover: hrData.turnover || 0,
            satisfaction: hrData.satisfaction || 0,
            training: hrData.training || 0,
          },
          vehicles: {
            totalVehicles: vehiclesData.totalVehicles || 0,
            active: vehiclesData.active || 0,
            maintenance: vehiclesData.maintenance || 0,
            fuelCost: vehiclesData.fuelCost || 0,
            mileage: vehiclesData.mileage || 0,
            efficiency: vehiclesData.efficiency || 0,
          },
          finance: {
            totalAssets: financeData.totalAssets || 0,
            liabilities: financeData.liabilities || 0,
            equity: financeData.equity || 0,
            cashFlow: financeData.totalRevenue - financeData.totalExpenses || 0,
            profitMargin: financeData.profitMargin || 0,
