-- ================================================================
-- ISP MANAGEMENT SYSTEM - COMPLETE CONSOLIDATED DATABASE SCHEMA
-- ================================================================
-- Single script for fresh installations
-- Creates ALL tables, columns, indexes, sequences, triggers, seed data
-- 100% idempotent - uses CREATE TABLE IF NOT EXISTS throughout
-- Safe to run multiple times on both fresh and existing databases
-- ================================================================
...
-- ================================================================
-- SECTION 28: ADD MISSING COLUMNS TO EXISTING TABLES
-- For databases that already have tables but are missing newer columns
-- ================================================================
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='customers' AND column_name='payment_method') THEN
        ALTER TABLE customers ADD COLUMN payment_method VARCHAR(50);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='customers' AND column_name='plan_type') THEN
        ALTER TABLE customers ADD COLUMN plan_type VARCHAR(50);
    END IF;

    -- customer_services missing columns
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='customer_services' AND column_name='pppoe_enabled') THEN
        ALTER TABLE customer_services ADD COLUMN pppoe_enabled BOOLEAN DEFAULT false;
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='customer_services' AND column_name='enforcement_mode') THEN
        ALTER TABLE customer_services ADD COLUMN enforcement_mode VARCHAR(50) DEFAULT 'radius';
    END IF;
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='customer_services' AND column_name='suspended_by') THEN
        ALTER TABLE customer_services ADD COLUMN suspended_by VARCHAR(100);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='customer_services' AND column_name='router_sync_status') THEN
        ALTER TABLE customer_services ADD COLUMN router_sync_status VARCHAR(50);
    END IF;

    -- service_plans missing columns
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='service_plans' AND column_name='plan_type') THEN
        ALTER TABLE service_plans ADD COLUMN plan_type VARCHAR(50);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='service_plans' AND column_name='monthly_fee') THEN
        ALTER TABLE service_plans ADD COLUMN monthly_fee NUMERIC(15,2);
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='invoices' AND column_name='tax') THEN
        ALTER TABLE invoices ADD COLUMN tax NUMERIC(15,2) DEFAULT 0;
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='invoices' AND column_name='total') THEN
        ALTER TABLE invoices ADD COLUMN total NUMERIC(15,2);
    END IF;

    -- invoice_items missing columns
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='invoice_items' AND column_name='total_price') THEN
        ALTER TABLE invoice_items ADD COLUMN total_price DECIMAL(10,2);
    END IF;

    -- supplier_invoice_items missing columns
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='supplier_invoice_items' AND column_name='item_name') THEN
        ALTER TABLE supplier_invoice_items ADD COLUMN item_name VARCHAR(255);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='supplier_invoice_items' AND column_name='unit_price') THEN
        ALTER TABLE supplier_invoice_items ADD COLUMN unit_price NUMERIC(12, 2);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='supplier_invoice_items' AND column_name='total_price') THEN
        ALTER TABLE supplier_invoice_items ADD COLUMN total_price NUMERIC(12, 2);
    END IF;

    -- network_devices missing columns
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='network_devices' AND column_name='mikrotik_host') THEN
        ALTER TABLE network_devices ADD COLUMN mikrotik_host VARCHAR(255);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='network_devices' AND column_name='mikrotik_port') THEN
        ALTER TABLE network_devices ADD COLUMN mikrotik_port INTEGER DEFAULT 8728;
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='network_devices' AND column_name='mikrotik_username') THEN
        ALTER TABLE network_devices ADD COLUMN mikrotik_username VARCHAR(100);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='network_devices' AND column_name='mikrotik_password') THEN
        ALTER TABLE network_devices ADD COLUMN mikrotik_password VARCHAR(255);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='network_devices' AND column_name='mikrotik_use_ssl') THEN
        ALTER TABLE network_devices ADD COLUMN mikrotik_use_ssl BOOLEAN DEFAULT false;
    END IF;

    -- ip_subnets missing columns
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='ip_subnets' AND column_name='network') THEN
        ALTER TABLE ip_subnets ADD COLUMN network VARCHAR(50);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='ip_subnets' AND column_name='network_address') THEN
        ALTER TABLE ip_subnets ADD COLUMN network_address VARCHAR(50);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='ip_subnets' AND column_name='dns_primary') THEN
        ALTER TABLE ip_subnets ADD COLUMN dns_primary VARCHAR(50);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='ip_subnets' AND column_name='dns_secondary') THEN
        ALTER TABLE ip_subnets ADD COLUMN dns_secondary VARCHAR(50);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='ip_subnets' AND column_name='notes') THEN
        ALTER TABLE ip_subnets ADD COLUMN notes TEXT;
    END IF;

    -- ip_addresses missing columns
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='ip_addresses' AND column_name='location_id') THEN
        ALTER TABLE ip_addresses ADD COLUMN location_id INTEGER;
    END IF;

    -- employees missing columns
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='employees' AND column_name='sha_number') THEN
        ALTER TABLE employees ADD COLUMN sha_number VARCHAR(100);
    END IF;
    ...
    -- balance_sheet_view missing id
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='balance_sheet_view' AND column_name='id') THEN
        ALTER TABLE balance_sheet_view ADD COLUMN id SERIAL PRIMARY KEY;
    END IF;

    -- account_balances missing columns
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='account_balances' AND column_name='credit_limit') THEN
        ALTER TABLE account_balances ADD COLUMN credit_limit NUMERIC(15,2) DEFAULT 0;
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='account_balances' AND column_name='status') THEN
        ALTER TABLE account_balances ADD COLUMN status VARCHAR(50) DEFAULT 'active';
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='routers' AND column_name='sync_status') THEN
        ALTER TABLE routers ADD COLUMN sync_status VARCHAR(50);
    END IF;
